      ...
      <div className="relative flex flex-col h-screen overflow-hidden">
        ...
        <main className="relative z-20 flex flex-col h-full overflow-hidden">
          ...
          <div className="px-6 py-4 mx-auto max-w-7xl flex-1 overflow-hidden flex flex-col min-h-0">
            <div className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-2xl shadow-2xl p-6 flex-1 flex flex-col min-h-0 overflow-hidden">
              <motion.div 
              ...
              >
                ...
                <p className="text-white/80">Manage users and monitor system activity</p>
              </motion.div>
              ...
              <AnimatePresence>
                {error && (
                  <motion.div
                    ...
                    className="mb-6 bg-red-500/20 backdrop-blur-lg border border-red-500/30 text-red-100 px-4 py-3 rounded-xl"
                  >
                    <div className="flex">
                      <div className="py-1">
                      ...
                      <button 
                        className="ml-auto text-red-300 hover:text-red-100 mr-2"
                        onClick={() => fetchData()}
                        title="Retry"
                      >
            ...
            <div className="flex-1 flex gap-6 min-h-0 overflow-hidden">
              ...
              >
                <div className="bg-blue-500/20 backdrop-blur-lg border border-blue-500/30 rounded-xl p-6 hover:bg-blue-500/25 transition-all duration-300">
                ...
                <div className="bg-green-500/20 backdrop-blur-lg border border-green-500/30 rounded-xl p-6 hover:bg-green-500/25 transition-all duration-300">
                  <div className="flex items-center">
                    <div className="p-3 bg-green-500/30 rounded-xl backdrop-blur-sm">
                    ...
                    <div className="ml-4">
                      <p className="text-sm font-medium text-green-100">Total Predictions</p>
                      <p className="text-2xl font-semibold text-white">{stats.totalPredictions}</p>
                    </div>
                  </div>
                </div>

                <div className="bg-purple-500/20 backdrop-blur-lg border border-purple-500/30 rounded-xl p-6 hover:bg-purple-500/25 transition-all duration-300">
                  <div className="flex items-center">
                    <div className="p-3 bg-purple-500/30 rounded-xl backdrop-blur-sm">
                      <svg className="w-6 h-6 text-purple-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                      </svg>
                    </div>
                    <div className="ml-4">
                      <p className="text-sm font-medium text-purple-100">New Users This Month</p>
                      <p className="text-2xl font-semibold text-white">{stats.newUsersThisMonth}</p>
                    </div>
                  </div>
                </div>
              </motion.div>

              {/* Right Side - User Management Table */}
              <motion.div 
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.2 }}
                className="flex-1 bg-white/20 backdrop-blur-lg border border-white/30 rounded-xl shadow-2xl overflow-hidden flex flex-col min-h-0"
              >
          ...
          {showPredictionModal && (
            ...
            >
              <motion.div
                ...
                className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[80vh] overflow-hidden"
              ...
              >
                ...
                <div className="px-6 py-4 border-b border-white/20 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-white/70 text-sm">View user's prediction statistics and history</p>
                  </div>
                  <button
                    onClick={() => {
                      setShowPredictionModal(false);
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                          <div className="text-2xl font-bold text-white">{userPredictionStats.stats.totalPredictions}</div>
                          <div className="text-white/70 text-sm">Total Predictions</div>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                          <div className="text-2xl font-bold text-white">{userPredictionStats.stats.thisMonthPredictions}</div>
                          <div className="text-white/70 text-sm">This Month</div>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                          <div className="text-2xl font-bold text-white">{userPredictionStats.stats.lastMonthPredictions}</div>
                          <div className="text-white/70 text-sm">Last Month</div>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                          <div className={`text-2xl font-bold ${userPredictionStats.stats.growthRate >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                      ...
                      {/* Recent Predictions */}
                      <div>
                        <h4 className="text-lg font-semibold text-white mb-4">Recent Predictions</h4>
